...
def lagigak():
	...
	if cblg == "n" or cblg == "N":
		...
		print ("Masukin Yang Bener ajg:)")
		time.sleep(2)
		lagigak()

#Ubah/Ganti Link Disini
def subs():
	print ("Subscribe Dulu Youtube ane Okey Cok!:)")
...
def tanya():
	try:
		...
		if am == "1":
			start()
		if am == "2":
			os.system("xdg-open https://wa.me/6287855190571?text=Assalamualaikum+Bang+*Laporan:*")
			lagigak()
		if am == "3":
			sys.exit
		if am == "" or am == " ":
...
\033[1;93m/_  ~~  _\       \033[1;96m/_______  /|__|__|_|  /______  /\____/|__|         \033[1;93m /_  ~~  _\\
  |_||_|                \033[1;95m \/          \/       \/                    \033[1;93m   |_||_|"""+Fore.RED)
	print ("            \t["+Back.WHITE+Fore.BLACK+"Copyright By ©Mr.X 2023 \033[00m"+Fore.RED+"]")
	print("")
...
def start():
	try:
		...
		logo()
		print()
		ha = input("\033[1;96mNama lu Cok: \033[1;92m")
